...
export default function ComingSoon() {
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden relative">
      ...
      {/* Navigation */}
      <nav className="w-full px-4 sm:px-6 md:px-12 lg:px-20 py-3">
        <div className="flex items-center justify-between">
          <div className="text-base sm:text-xl tracking-wider font-medium uppercase">
            HEAL AND PLAY
          </div>
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            {user ? (
              <button
                ...
                className="text-xs sm:text-sm tracking-wider uppercase px-2.5 sm:px-3 py-1.5 bg-dark text-beige rounded-lg hover:bg-dark/90 transition-colors"
              >
                Mi Dashboard
              </button>
            ) : (
              <>
                ...
                <button
                  ...
                  className="text-xs sm:text-sm tracking-wider uppercase px-2.5 sm:px-3 py-1.5 border border-dark/20 rounded-lg text-dark/70 hover:text-dark hover:border-dark/40 transition-colors whitespace-nowrap"
                >
                  Iniciar Sesión
                </button>
              </>
